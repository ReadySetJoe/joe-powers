    ...
    <div className={`${styles.container} ${darkMode ? 'dark' : ''}`}>
      ...
      <DarkModeToggle darkMode={darkMode} toggleDarkMode={toggleDarkMode} />
        ...
        <p className={styles.description}>
          One day I'm gonna do some <code style={{color: 'black'}}>{darkMode ? 'bullshit' : 'coding'}</code> here
        </p>
        <br />
        ...
        <div className={styles.grid}>
          ...
          >
            ...
            <br />
            <p>For gamers. By gamer. <br />...it's me, I'm the gamer.</p>
          </a>
          <a
          ...
          >
            ...
            <p>
              Used for comparing two things, and deciding which is better.
            </p>
            <br />
            <p>As long as those two things are entrants in start.gg tournaments.</p>
          </a>
          <a
          ...
          >
            <h3>Slippi Stats</h3>
            <p>
              A half-baked project based on parsing online melee slippi replay files.
            </p>
            <br />
